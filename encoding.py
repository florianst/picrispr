...
def noSequence(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToOneHot, count=None, i=0, featurenames=None, numBpWise=0):
...
def noEncoding(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToOneHot, count=None, i=0, featurenames=None, numBpWise=0):
...
def oneHotSingleNuclTargetMismatchType(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToOneHot, count=None, i=0, featurenames=None, numBpWise=0):
...
def oneHotSingleNuclTargetMismatch(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToOneHot, count=None, i=0, featurenames=None, numBpWise=0):
...
def oneHotSingleNucl(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToOneHot, count=None, i=0, featurenames=None, numBpWise=0):
    ...
    # turn both grna and target sequence into 23*4 long one-hot vectors
    experiment = turnToOneHot(experiment, seqToOneHot=seqToOneHot, encodingFunction="oneHotSingleNucl", numBpWise=numBpWise)
    augmented  = turnToOneHot(augmented,  seqToOneHot=seqToOneHot, encodingFunction="oneHotSingleNucl", numBpWise=numBpWise)
    
    return experiment, augmented, encoding, pt

def oneHotDinuclTargetMismatch(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToDinucleotides, count=None, i=0, featurenames=None, numBpWise=0):
...
def oneHotDinucl(experiment, augmented, cutoff, CFtoScore=normaliseCF, seqToOneHot=seqToDinucleotides, count=None, i=0, featurenames=None, numBpWise=0):
